...
function loadData() {
  ...
  dracoLoader.setDecoderPath('draco/'); // Ensure the correct path to the Draco decoder
  loader.setDRACOLoader(dracoLoader);

  loader.setPath(''); // Optional: set path if your model file is located in a specific folder
  loader.load('3d-vh-m-united-v1.glb', gltfReader);
}
